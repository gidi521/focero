export default {
	...
	required: 'Pflichtfelder dürfen nicht leer sein',
	header: {
		tab1: 'Startseite',
		tab2: 'Blogger',
	},
	countDown: {
		...
		switch1: 'Starten',
		switch2: 'Pausieren',
		popupTitle: 'Benachrichtigung',
		popupContent: 'Mission abgeschlossen!'
	},
	bg: {
		bgTitle: 'Hintergrund'
	},
	task: {
		taskTitle: 'Setze deine Aufgabe',
		inpPlaceholder: 'Gib einen Aufgabennamen ein'
	},
	settings: {
		notifTitle: 'Warnung',
		notifContent: 'Du hast Benachrichtigungen blockiert. Bitte aktiviere sie in den Browsereinstellungen für die beste Erfahrung.',
	},
	intro: {
		HeroHeading: 'Bleib fokussiert. Erledige mehr.',
		Subheadline: 'Focero ist ein einfaches, aber leistungsstarkes Online-Pomodoro-Timer-Tool, das dir hilft, fokussiert zu bleiben, Prokrastination zu überwinden und tiefe Konzentration zu erreichen – egal ob du lernst, arbeitest oder einfach nur konzentriert bleiben möchtest.',
		one: {
			title: 'Warum Focero?',
			content: 'Focero wurde mit Einfachheit und Klarheit entwickelt. Keine Werbung, keine Anmeldung, keine Ablenkungen. Nur ein effizienter Timer, der die bewährte Pomodoro-Technik folgt – 25 Minuten Fokus, 5 Minuten Pause. Perfekt für Studenten, Berufstätige, Schriftsteller, Programmierer und alle, die ihre Zeit besser managen und in den Flow kommen möchten.',
		},
		two: {
			title: 'Wie es funktioniert',
			list: {
				li1: 'Stelle eine 25-minütige Fokuszeit ein.',
				li2: 'Arbeite mit voller Aufmerksamkeit an deiner Aufgabe.',
				li3: 'Mache eine 5-minütige Pause.',
				li4: 'Wiederhole es. Alle 4 Zyklen mach eine längere Pause.',
			}
		},
		three: {
			title: 'Focero Funktionen',
			list: {
				li1: '⏱ Pomodoro-Timer – Sauberer und intuitiver Arbeitsablauf',
				li2: '🎨 Inspirierende Themen – Weltweite Szenen oder minimalistische Stile',
				li3: '📱 Mobilfreundlich – Auf jedem Gerät flüssig',
				li4: '🧘‍♀️ Pausenwarnungen – Ruhe dich aus, bevor du ausbrennst',
				li5: '🎧 Umgebungsgeräusche – Beruhigende Fokus-Audio mischen',
				li6: '✅ Fokus-Aufgaben – Eine Aufgabe, volle Aufmerksamkeit',
			}
		},
		four: {
			title: 'Focero: Der beste Pomodoro-Timer für Produktivität',
